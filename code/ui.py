...
class UI:
    ...
    def weapon_overlay(self, weapon_index, has_switched):
        ...
        weapon_rectangle = weapon_surface.get_rect(center=bg_rect.center)
        self.display_surface.blit(weapon_surface, weapon_rectangle)

    def magic_overlay(self, magic_index, has_switched):
        bg_rect = self.selection_box(90, 630, has_switched)  # weapon
        magic_surface = self.magic_graphics[magic_index]
        magic_rectangle = magic_surface.get_rect(center=bg_rect.center)
        self.display_surface.blit(magic_surface, magic_rectangle)
